...
<nav id="quick-menu-footer" class="hidden-lg hidden-md" >
    <div class="f-menu-item ActiveMenu"><a  href="{SITE_URL}home"><i class="fa fa-home" style="font-size: 16px;"></i><div class="name">{LANG_HOME}</div></a></div>

    <div class="f-menu-item cart ActiveMenu"><a  href="{SITE_URL}favourite"><i class="fa fa-heart" style="font-size: 16px;"></i><div class="name">{LANG_FAVOURITES}</div></a></div>
    <div class="f-menu-item ActiveMenu"><a href="{SITE_URL}post-ad"><i class="fa fa-plus-circle border with-icon" style="font-size: 50px;color:#04407b;"> </i></a></div>

    <div class="f-menu-item ActiveMenu"><a  href="{SITE_URL}message"><i class="fa fa-envelope" style="font-size: 16px;"></i><div class="name">{LANG_MESSAGE}</div></a></div>


    <div class="f-menu-item ActiveMenu"><a  href="{SITE_URL}dashboard"><i class="fa fa-user" style="color:font-size: 16px;"></i><div class="name">{LANG_MY_ACCOUNT}</div></a></div>
</nav>
<!-- //nav menu end /// -->
</body></html>