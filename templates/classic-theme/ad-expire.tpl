                    ...
                    <div class="section">
                        <div class="user-panel-sidebar">
                            <div class="collapse-box">
                                <h5 class="collapse-title no-border"> {LANG_MY_CLASSIFIED}
                                    <a class="pull-right" data-toggle="collapse" href="#MyClassified"><i class="fa fa-angle-down"></i></a>
                                </h5>
                    ...
                    <div class="my-quickad section">
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <tr class="ajax-item-listing" data-item-id="{ITEM.id}">
                                <td class="title-container"><img src="{SITE_URL}storage/products/thumb/{ITEM.picture}" alt="" style="max-height: 200px">
                                ...
                                <td class="action" width="12%"><a href="{LINK_EDIT-AD}/{ITEM.id}"><i class="fa fa-pencil"></i> {LANG_RENEW}</a><a class="delete item-js-delete" href="#" data-ajax-action="deleteMyAd"><i class="fa fa-remove"></i> {LANG_DELETE}</a></td>
                            </tr>
                            {/LOOP: ITEM}
                            </tbody>
                        </table>
