        ...
        <div class="row">
                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="{LANG_MY_ADS}">
                                        ...
                                        <li class="active"><a href="{LINK_EXPIREADS}"><i class="icon-feather-alert-octagon"></i> {LANG_EXPIRE_ADS} <span class="nav-tag">{TOTALITEM}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-alert-octagon"></i> {LANG_EXPIRE_ADS}</h3>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                <tr class="ajax-item-listing" data-item-id="{ITEM.id}">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="job-listing-footer font-14">
                                                            <ul>
                                                                ...
                                                                <li><i class="la la-calendar-times-o"></i> {LANG_EXPIRED_ON}: {ITEM.expire_date}</li>
                                                            </ul>
                                                            IF("{ITEM.price}"!="0"){
                                    ...
                                    <td>
                                        <a href="{LINK_EDIT-AD}/{ITEM.id}" class="button gray ripple-effect ico" data-tippy-placement="top" title="{LANG_RENEW}"><i class="icon-feather-edit"></i></a>
