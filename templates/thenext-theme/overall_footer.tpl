...
<div id="footer">
    ...
    <div class="footer-bottom-section">
        <div class="container">
            <div class="row">
                <div class="col-xl-12 mobile-fotter" >
...
<!-- ////nav menu ////  -->
<nav id="quick-menu-footer" class="hidden-lg hidden-md"  style="background-color:#76ba1b">
    ...
    <div class="f-menu-item ActiveMenu"><a  href="{SITE_URL}dashboard"><i class="fa fa-user" style="font-size: 18px; color:white"></i><div class="name" style="font-size:0.7em; color:white">Account</div></a></div>
</nav>
<!-- //nav menu end /// -->
<!-- footer -->
