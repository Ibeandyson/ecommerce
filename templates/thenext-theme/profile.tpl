                            ...
                            <div class="job-listing-details">
                                <div class="job-listing-company-logo" style="position:relative;">
                                    ...
                                    <div style="position:absolute;top:4px;left:4px;">
                                        <span style="background:rgba(0,0,0,.25);padding:0px 7px;border-radius:15px;color:#f00;display:block;font-size:12px;line-height:1.5rem;"><b>Urgent</b></span>
                                    </div>
                                    {:IF}
                                    IF("{ITEM.featured}"=="1"){
                                    <div style="position:absolute;top:4px;right:4px;">
                                        <span style="background:rgba(0,0,0,.25);padding:0px 7px;border-radius:15px;color:#0f0;display:block;font-size:12px;line-height:1.5rem;">Featured</span>
                                    </div>
                                    {:IF}
                                    IF("{ITEM.highlight}"=="1"){
                                    <div style="position:absolute;bottom:5px;left:5px;">
                                        <span style="background:rgba(255,255,255,1);padding:4px;border-radius:15px;box-shadow:1px 1px 2px #666;color: rgba(255,165,0,1);display:block;font-size:14px;line-height:1rem;"> <i class="la la-star"></i> Featured</span>
                                    </div>
                                    {:IF}
