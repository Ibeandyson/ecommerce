    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-md-12">
                ...
                <form id="post_job_form" action="{LINK_POST-AD}?action=post_ad" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="submit-field">
                                        <h5>{LANG_TITLE} *</h5>
                                        <input type="text" class="with-border" name="title" placeholder="{LANG_AD_TITLE}">
                                    </div>
                                    <div class="submit-field">
