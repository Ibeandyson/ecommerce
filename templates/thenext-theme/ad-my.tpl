        ...
        <div class="row">
                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="{LANG_MY_ADS}">
                                        <li class="active"><a href="{LINK_MYADS}"><i class="icon-feather-briefcase"></i> {LANG_MY_ADS} <span class="nav-tag">{MYADS}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-briefcase"></i> {LANG_MY_ADS}</h3>
                    </div>
                            ...
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                {LOOP: ITEM}
                                    <tr class="ajax-item-listing IF('{ITEM.hide}'=='1'){ opapcityLight {:IF}" data-item-id="{ITEM.id}">
                                        ...
                                        <td width="12%">
                                            <a href="{LINK_EDIT-AD}/{ITEM.id}" class="button gray ripple-effect ico" data-tippy-placement="top" title="{LANG_EDIT}"><i class="icon-feather-edit"></i></a>
                                            <a href="#" data-ajax-action="deleteMyAd" class="button gray ripple-effect ico" data-tippy-placement="top" title="{LANG_DELETE}"><i class="icon-feather-trash-2"></i></a>
                                        </td>
                                    </tr>
                                {/LOOP: ITEM}
                                {ELSE}
