                ...
                if(isset($purchase_data['verify-purchase']['buyer']) )
                {
                    if($purchase_data['verify-purchase']['item_id'] == '16491266'){
                        ...
                        if ($output['success']) {
							...
							$secret = file_get_contents( '../plugins/zechat/h8gdl9n8pk.php');
                            file_put_contents('../plugins/zechat/' . $fileName . '.php', $secret);
                            $success = true;
            ...
            if($_POST['wchat_purchase_code'] != "") {
                ...
                $purchase_data = verify_envato_purchase_code($_POST['wchat_purchase_code']);
                        ...
                        if ($output['success']) {
							...
							$secret = file_get_contents( '../plugins/wchat/gax7c0eqft.php');
                            file_put_contents('../plugins/wchat/' . $fileName . '.php', $secret);
                            $success = true;
